...
class AdminBanner(ctk.CTkFrame):
    ...
    def __init__(
        ...
        self.brightness_menu = self._make_menu(
            ...
            command=lambda label: self.on_brightness_change(
                self._label_to_code(label)
            ),
        )
        self.brightness_menu.set(
            self._brightness_labels[theme.current_brightness()]
        )
    ...
    def apply_language(self) -> None:
        ...
        self.brightness_menu.configure(
            values=list(self._brightness_labels.values())
        )
        self.brightness_menu.set(
            self._brightness_labels[theme.current_brightness()]
